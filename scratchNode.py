...
from pixelSmith_GraphicEditor.CommonMenu.graphicEditorMenuBar import MenuBar
from pixelSmith_GraphicEditor.elements.nodeV2_1.AbstractClass.AbstractNodeGraphicV1_2 import AbstractNodeGraphic
from pixelSmith_GraphicEditor.elements.nodeV2_1.AbstractClass.AbstractNodeInterfaceV1_2 import AbstractNodeInterface
from pixelSmith_GraphicEditor.inkIt_graphicEditor import GraphicEditor
from ArguePy_CodeEditor.arguePy import ArguePy

"""
QMainWindow for GraphicEditor
"""


class mainGraphicEditorWindow(QMainWindow):
    menu: MenuBar
    ...
    def initDockForGraphicEditor(self):
        self.graphicEditor = GraphicEditor(self)
        frame = QFrame()
        frame.setFrameStyle(QFrame.Shape.StyledPanel)
        frame.setStyleSheet(
            "background-color: rgb(50, 50, 50);" "border: 1px solid rgb(20, 20, 20);" "border-radius: 5px;")
        frame.setContentsMargins(10, 10, 5, 10)
        frame.setLayout(QVBoxLayout())
        frame.layout().addWidget(self.graphicEditor)
        self.dockGraphicEditor = QDockWidget("Graphic Editor", self)
    ...
    def initDockForCodeEditor(self):
        ...
        self.dockCodeEditor = QDockWidget("Code Editor", self)
