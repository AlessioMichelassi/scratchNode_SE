...
from ArguePy_CodeEditor.editorWidgetTool.tools.SintaxHighlighters.pyHighLighter import pythonHighLighter
from ArguePy_CodeEditor.editorWidgetTool.tools.lineNumberWidget import LineNumberArea
